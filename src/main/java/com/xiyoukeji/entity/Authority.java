...
public class Authority {
    ...
    private List<CommentTab> project_comments = new ArrayList<>();
    ...
    public List<CommentTab> getProject_comments() {
        return project_comments;
    }

    public void setProject_comments(List<CommentTab> project_comments) {
